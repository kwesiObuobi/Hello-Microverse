...
**Hello Microverse** is a project in the first stages of the Microverse full stack curriculum, which aims to teach students to follow the professional workflow in using github.
...
- **Includes an HTML file with h1 tag**
- **Includes a CSS file which is linked to the HTML file**
